...
| discrete_signal_to_noise_ratio | \[0, 1\]    | 0.9 | Defines the probability that uniform noise is added within the mixed additive noise model, i.e., 0 = no noise, and 1 = uniform discrete noise  |
