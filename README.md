...
| variables_scaling | {'normal', 'standard', 'rank', 'rank', 'uniform'} | 'normal' | 'Scale the continuous variables ('normal' or standard') or all variables ('rank' or 'uniform’) in the dataset once all samples are generated. |
