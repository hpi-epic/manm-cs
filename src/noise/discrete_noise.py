...
from src.prob_distributions.discrete import DiscreteDistribution, CustomDiscreteDistribution
...
class DiscreteNoise(Noise):
    ...
    @staticmethod
    def builder() -> 'DiscreteNoiseBuilder':
        return DiscreteNoiseBuilder()
